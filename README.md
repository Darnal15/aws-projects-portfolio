...
| [AWS Log Archival Lifecycle Automation](./aws-log-archiver/README.md) | Python automation that generates logs, compresses them into ZIP archives, uploads them to Amazon S3 using Boto3, and schedules execution with Cron on an EC2 instance. | Python, EC2, S3, IAM, Boto3, Cron | Beginner |
